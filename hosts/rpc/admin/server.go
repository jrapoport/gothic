...
func newAdminServer(srv *rpc.Server) *server {
...
func (s *server) rootContext(ctx context.Context) context.Context {
...
func (s *server) adminRequestContext(ctx context.Context) (core_ctx.Context, error) {
